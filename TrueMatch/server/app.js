// =============================================
//  TRUEMATCH - EXPRESS APPLICATION SETUP
// =============================================
// This file creates and configures the Express app.
// Following MVC Architecture:
//   Model      → models/       (Mongoose schemas)
//   View       → React client  (frontend SPA)
//   Controller → controllers/  (business logic)
// Routes act as the bridge between View and Controller.
// =============================================
...
// --- Import route files (Router-level middleware) ---
...
// =============================================
// API ROUTES (Controller binding via Router)
